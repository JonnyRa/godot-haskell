...
pattern RESULT_DOWNLOAD_FILE_WRITE_ERROR = 11
...
pattern RESULT_REDIRECT_LIMIT_REACHED = 12

pattern RESULT_BODY_DECOMPRESS_FAILED :: Int

pattern RESULT_BODY_DECOMPRESS_FAILED = 8

pattern RESULT_DOWNLOAD_FILE_CANT_OPEN :: Int

pattern RESULT_DOWNLOAD_FILE_CANT_OPEN = 10
...
pattern RESULT_REQUEST_FAILED = 9

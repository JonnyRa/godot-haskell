...
pattern OPENGL_CONTEXT :: Int

pattern OPENGL_CONTEXT = 4
...
pattern APPLICATION_HANDLE :: Int

pattern APPLICATION_HANDLE = 0
...
pattern WINDOW_HANDLE :: Int

pattern WINDOW_HANDLE = 2
...
pattern WINDOW_VIEW :: Int

pattern WINDOW_VIEW = 3
...
pattern DISPLAY_HANDLE :: Int

pattern DISPLAY_HANDLE = 1

...
pattern FLAG_DRAW_NEXT_FRAME_IF_VISIBLE :: Int

pattern FLAG_DRAW_NEXT_FRAME_IF_VISIBLE = 1
...
pattern LIGHTMAP_SCALE_2X :: Int

pattern LIGHTMAP_SCALE_2X = 1

pattern SHADOW_CASTING_SETTING_OFF :: Int

pattern SHADOW_CASTING_SETTING_OFF = 0

pattern LIGHTMAP_SCALE_4X :: Int

pattern LIGHTMAP_SCALE_4X = 2
...
pattern LIGHTMAP_SCALE_8X :: Int

pattern LIGHTMAP_SCALE_8X = 3

pattern LIGHTMAP_SCALE_1X :: Int

pattern LIGHTMAP_SCALE_1X = 0

pattern LIGHTMAP_SCALE_MAX :: Int

pattern LIGHTMAP_SCALE_MAX = 4
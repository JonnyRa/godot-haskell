...
--   				__Note:__ You must check that the state of the return PacketPeerUDP is @PacketPeerDTLS.STATUS_HANDSHAKING@, as it is normal that 50% of the new connections will be invalid due to cookie exchange.

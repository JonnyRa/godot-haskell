...
module Godot.Core.KinematicBody
       (Godot.Core.KinematicBody._PLATFORM_VEL_ON_LEAVE_NEVER,
        ...
        Godot.Core.KinematicBody.is_sync_to_physics_enabled,
...
instance NodeProperty KinematicBody "axis_lock_motion_y" Bool
           'False
         where
        nodeProperty
...
instance NodeProperty KinematicBody "axis_lock_motion_z" Bool
           'False
         where
        nodeProperty
...
instance NodeProperty KinematicBody "motion/sync_to_physics" Bool
           'False
         where
        nodeProperty
...
bindKinematicBody__direct_state_changed :: MethodBind
bindKinematicBody__direct_state_changed
  = unsafePerformIO $
...
_direct_state_changed ::
                        (KinematicBody :< cls, Object :< cls) => cls -> Object -> IO ()
_direct_state_changed cls arg1
  = withVariantArray [toVariant arg1]
      (\ (arrPtr, len) ->
         godot_method_bind_call bindKinematicBody__direct_state_changed
           (upcast cls)
           arrPtr
           len
           >>=
...
instance NodeMethod KinematicBody "_direct_state_changed" '[Object]
           (IO ())
         where
        nodeMethod = Godot.Core.KinematicBody._direct_state_changed
...
{-# NOINLINE bindKinematicBody_get_floor_angle #-}

-- | Returns the floor's collision angle at the last collision point according to @up_direction@, which is @Vector3.UP@ by default. This value is always positive and only valid after calling @method move_and_slide@ and when @method is_on_floor@ returns @true@.
bindKinematicBody_get_floor_angle :: MethodBind
bindKinematicBody_get_floor_angle
  = unsafePerformIO $
      withCString "KinematicBody" $
        \ clsNamePtr ->
...
get_floor_angle cls arg1
  = withVariantArray
      ...
      (\ (arrPtr, len) ->
         godot_method_bind_call bindKinematicBody_get_floor_angle
           (upcast cls)
           arrPtr
           len
           >>=
...
instance NodeMethod KinematicBody "get_floor_angle"
           '[Maybe Vector3]
           (IO Float)
         where
        nodeMethod = Godot.Core.KinematicBody.get_floor_angle
...
{-# NOINLINE bindKinematicBody_get_last_slide_collision #-}
...
bindKinematicBody_get_last_slide_collision :: MethodBind
bindKinematicBody_get_last_slide_collision
  = unsafePerformIO $
      withCString "KinematicBody" $
        \ clsNamePtr ->
...
get_last_slide_collision ::
                           (KinematicBody :< cls, Object :< cls) =>
                           cls -> IO KinematicCollision
get_last_slide_collision cls
  = withVariantArray []
      (\ (arrPtr, len) ->
         godot_method_bind_call bindKinematicBody_get_last_slide_collision
           (upcast cls)
           arrPtr
           len
           >>= \ (err, var) -> throwIfErr err >> fromGodotVariant var)

instance NodeMethod KinematicBody "get_last_slide_collision" '[]
...
{-# NOINLINE bindKinematicBody_is_sync_to_physics_enabled #-}
...
bindKinematicBody_is_sync_to_physics_enabled :: MethodBind
bindKinematicBody_is_sync_to_physics_enabled
  = unsafePerformIO $
      withCString "KinematicBody" $
        \ clsNamePtr ->
...
is_sync_to_physics_enabled cls
  = withVariantArray []
      (\ (arrPtr, len) ->
         godot_method_bind_call bindKinematicBody_is_sync_to_physics_enabled
           (upcast cls)
           arrPtr
           len
           >>=
...
instance NodeMethod KinematicBody "is_sync_to_physics_enabled" '[]
           (IO Bool)
         where
        nodeMethod = Godot.Core.KinematicBody.is_sync_to_physics_enabled
...
{-# NOINLINE bindKinematicBody_set_sync_to_physics #-}

-- | If @true@, the body's movement will be synchronized to the physics frame. This is useful when animating movement via @AnimationPlayer@, for example on moving platforms. Do __not__ use together with @method move_and_slide@ or @method move_and_collide@ functions.
bindKinematicBody_set_sync_to_physics :: MethodBind
bindKinematicBody_set_sync_to_physics
  = unsafePerformIO $
      withCString "KinematicBody" $
        \ clsNamePtr ->
...
-- | If @true@, the body's movement will be synchronized to the physics frame. This is useful when animating movement via @AnimationPlayer@, for example on moving platforms. Do __not__ use together with @method move_and_slide@ or @method move_and_collide@ functions.
set_sync_to_physics ::
                      (KinematicBody :< cls, Object :< cls) => cls -> Bool -> IO ()
set_sync_to_physics cls arg1
  = withVariantArray [toVariant arg1]
      (\ (arrPtr, len) ->
         godot_method_bind_call bindKinematicBody_set_sync_to_physics
           (upcast cls)
           arrPtr
           len
           >>=
...
instance NodeMethod KinematicBody "set_sync_to_physics" '[Bool]
           (IO ())
         where
        nodeMethod = Godot.Core.KinematicBody.set_sync_to_physics

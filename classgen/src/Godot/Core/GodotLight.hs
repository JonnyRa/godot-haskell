...
pattern PARAM_SPOT_ATTENUATION = 7

pattern PARAM_CONTACT_SHADOW_SIZE :: Int

pattern PARAM_CONTACT_SHADOW_SIZE = 8

pattern PARAM_SHADOW_NORMAL_BIAS :: Int

pattern PARAM_SHADOW_NORMAL_BIAS = 13

pattern PARAM_SHADOW_MAX_DISTANCE :: Int

pattern PARAM_SHADOW_MAX_DISTANCE = 9

pattern PARAM_SHADOW_SPLIT_1_OFFSET :: Int

pattern PARAM_SHADOW_SPLIT_1_OFFSET = 10
...
pattern PARAM_SPECULAR = 3

pattern PARAM_SHADOW_BIAS :: Int

pattern PARAM_SHADOW_BIAS = 14

pattern PARAM_ATTENUATION :: Int

pattern PARAM_ATTENUATION = 5

pattern PARAM_SIZE :: Int

pattern PARAM_SIZE = 2

pattern PARAM_SHADOW_BIAS_SPLIT_SCALE :: Int

pattern PARAM_SHADOW_BIAS_SPLIT_SCALE = 15

pattern PARAM_SHADOW_SPLIT_2_OFFSET :: Int

pattern PARAM_SHADOW_SPLIT_2_OFFSET = 11
...
pattern PARAM_SHADOW_SPLIT_3_OFFSET = 12

pattern PARAM_RANGE :: Int

pattern PARAM_RANGE = 4

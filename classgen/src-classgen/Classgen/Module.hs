...
mkMethod cls method doc = do
  ...
  where
    ...
    mkDefault (CoreType "PoolColorArray") "[]" v = [hs|defaultedVariant VariantPoolColorArray V.empty $v |]
    mkDefault (CoreType "PoolByteArray") "[PoolByteArray]" v = [hs|defaultedVariant VariantPoolByteArray V.empty $v |]
    mkDefault (CoreType "PoolByteArray") "[]" v = [hs|defaultedVariant VariantPoolByteArray V.empty $v |]
